            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {skills.map((skill, index) => (
                        <motion.div
                            key={skill.id}
                            className="bg-background/80 backdrop-blur-md border border-border rounded-xl shadow-md p-6 rounded-xl card-hover"
                        ...
                        >
                            <div className="flex flex-col items-center">
                                ...
                                >
                                    <img src={skill.icon} alt={skill.name} className=" object-contain" />
                                </div>
