                ...
                animate={{
                  background: [
                    `linear-gradient(90deg, ${
                      theme === 'dark' ? '#9333ea' : '#9333ea'
                    } 0%, ${theme === 'dark' ? '#4f46e5' : '#4f46e5'} 100%)`,
      ...
      {isMenuOpen && (
        <div className="md:hidden px-4 pb-4 glass">
          <nav className="flex flex-col space-y-4">
            <div
              onClick={() => scrollToSection('profile')}
              className="text-center py-2 hover:text-primary transition-colors cursor-pointer"
            >
              {t('nav.home')}
            </div>
            <div
