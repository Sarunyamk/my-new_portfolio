...
const projects: Project[] = [
    {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1741986947217-d1a0ecc39149?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwyfHx8ZW58MHx8fHx8',
        style: 'standard'
    },
    {
        id: 2,
...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, isFlipped, toggleFlip }) => {
    const getCardClass = () => {
        ...
        switch (project.style) {
            case 'modern':
                return `${baseClasses} glass border-2 border-primary/30`;
            case 'creative':
